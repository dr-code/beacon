...
version: 1.0.0
examples:
  - "Fires when Claude Code finishes a session, sending a rich embed with file changes, tool usage, and session duration to Discord"
  - "Triggers on every Stop event to deliver structured Discord notifications including session metadata and a full activity summary"
  - "Set up discord-detailed-notifications so my team gets a detailed Discord embed when Claude finishes a task"
---
