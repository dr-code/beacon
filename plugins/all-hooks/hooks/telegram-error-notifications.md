...
version: 1.0.0
examples:
  - "Fires after every Bash tool call, sending a Telegram alert when a command runs long or produces an error"
  - "Triggers after shell command execution to notify you via Telegram about slow or failed operations"
  - "Set up telegram-error-notifications so my Telegram gets a message whenever a Claude shell command fails or stalls"
---
