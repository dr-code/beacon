...
version: 1.0.0
examples:
  - "Fires after every tool call, logging CPU and memory usage to track resource consumption during a session"
  - "Triggers after each Claude operation to record system performance metrics for later review"
  - "Set up performance-monitor so I can see how much CPU and RAM Claude operations consume on my machine"
---
