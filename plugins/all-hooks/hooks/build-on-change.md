...
version: 1.0.0
examples:
  - "Fires after every Edit tool call to trigger the project build automatically"
  - "Fires whenever Claude edits a source file, running the configured build command"
  - "Trigger my build script automatically every time Claude makes a code change"
---
