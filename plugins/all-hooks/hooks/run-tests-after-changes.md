...
version: 1.0.0
examples:
  - "Fires after every Edit call, executing the project's fast test suite to catch regressions immediately"
  - "Triggers automatically when Claude modifies a source file, running targeted tests to validate the change"
  - "Set up run-tests-after-changes so my test suite runs automatically every time Claude edits code"
---
