...
version: 1.0.0
examples:
  - "Fires after every Edit call, discovering and running tests relevant to the modified file"
  - "Triggers automatically when Claude changes a source file, executing the associated test suite to catch breakage early"
  - "Set up test-runner so my tests run automatically every time Claude edits any source file"
---
