...
version: 1.0.0
examples:
  - "Fires before Edit, MultiEdit, or Write calls to prevent modifications to designated critical files"
  - "Triggers on every pre-write event to enforce a safelist of files that must never be changed"
  - "Set up file-protection to make sure Claude never touches my secrets.yaml or database migration files"
---
