...
examples:
  - "Use the payment-integration agent to add Stripe subscriptions and webhook handling to this app"
  - "Have the payment-integration agent implement a PCI-compliant checkout flow with PayPal support"
  - "Use the payment-integration agent to set up billing and subscription management for our SaaS"
---
