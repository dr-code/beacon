...
examples:
  - "Use the academic-research-synthesizer to do a literature review on transformer architectures"
  - "Have the academic-research-synthesizer pull together recent research on CRISPR off-target effects with citations"
  - "Run the academic-research-synthesizer to investigate the current state of quantum error correction research"
---
