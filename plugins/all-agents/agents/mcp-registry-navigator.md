...
examples:
  - "Use the mcp-registry-navigator to find MCP servers with database query capabilities"
  - "Have the mcp-registry-navigator evaluate the trustworthiness of these registry entries before I integrate them"
  - "Use the mcp-registry-navigator to generate a configuration for the best file system MCP server available"
---
