...
examples:
  - "Use the tag agent to normalize and deduplicate the tags across my entire knowledge base"
  - "Have the tag agent build a hierarchical taxonomy from these flat tags"
  - "Run the tag agent to consolidate duplicate and near-duplicate tags in this vault"
---
