...
examples:
  - "Use the podcast-transcriber to convert this audio file into a timestamped transcript"
  - "Have the podcast-transcriber generate a speaker-identified transcript from this recorded interview"
  - "Use the podcast-transcriber to produce structured transcript data with segment timestamps for this episode"
---
