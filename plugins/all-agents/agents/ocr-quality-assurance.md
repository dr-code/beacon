...
examples:
  - "Use the ocr-quality-assurance agent to do a final validation pass on this corrected OCR text"
  - "Have the ocr-quality-assurance agent verify this processed document against the original scanned image"
  - "Run the ocr-quality-assurance agent as the last step in our OCR pipeline before we store these results"
---
