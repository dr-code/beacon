...
category: data-ai
examples:
  - "Use the ml-engineer to integrate this PyTorch model into our production serving pipeline"
  - "Have the ml-engineer set up A/B testing and monitoring for our recommendation model"
  - "Use the ml-engineer to build the feature engineering pipeline for this classification task"
---
