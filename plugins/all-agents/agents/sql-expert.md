...
examples:
  - "Use the SQL expert to rewrite this slow query with proper indexing"
  - "Have the SQL expert design the schema for this multi-tenant application"
  - "Run the SQL expert to build a complex aggregation query across these joined tables"
---
