...
examples:
  - "Use the episode-orchestrator to manage this multi-step podcast production workflow"
  - "Have the episode-orchestrator coordinate the agents needed to process this episode from transcript to publish"
  - "Run the episode-orchestrator to dispatch the right agent sequence for this episode"
---
