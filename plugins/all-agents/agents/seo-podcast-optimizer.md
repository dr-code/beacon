...
examples:
  - "Use the SEO podcast optimizer to write a search-optimized title and description for this episode"
  - "Have the SEO podcast optimizer identify keywords we should target for this tech podcast episode"
  - "Run the SEO podcast optimizer to improve click-through rates on our episode listings"
---
