...
examples:
  - "Use the timestamp precision specialist to find the exact cut points for removing this filler section"
  - "Have the timestamp precision specialist extract frame-accurate speech boundaries from this podcast recording"
  - "Run the timestamp precision specialist to identify clean transition points for this audio edit"
---
