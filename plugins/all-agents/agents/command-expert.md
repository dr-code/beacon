...
examples:
  - "Use the command-expert to build a CLI tool with subcommands and flag parsing"
  - "Have the command-expert design the argument interface for this database migration script"
  - "Run the command-expert to add tab completion support to this shell utility"
---
