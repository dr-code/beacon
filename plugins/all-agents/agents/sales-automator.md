...
examples:
  - "Use the sales automator to draft a cold email sequence for this SaaS product"
  - "Have the sales automator write follow-up templates for leads that went cold after a demo"
  - "Run the sales automator to create a pricing page and case study for this service"
---
