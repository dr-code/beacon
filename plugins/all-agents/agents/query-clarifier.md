...
examples:
  - "Use the query clarifier to check if my research question is specific enough before I start"
  - "Have the query clarifier analyze this research prompt and flag any ambiguities"
  - "Run the query clarifier at the start of this research workflow to sharpen the scope"
---
