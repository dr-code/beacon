...
examples:
  - "Use the quant analyst to backtest this momentum strategy on historical SPY data"
  - "Have the quant analyst calculate the Sharpe ratio and max drawdown for this portfolio"
  - "Run the quant analyst to build a mean-variance optimization model for these assets"
---
