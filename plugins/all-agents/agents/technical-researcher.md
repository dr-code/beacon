...
examples:
  - "Use the technical researcher to evaluate whether this open-source library fits our requirements"
  - "Have the technical researcher review the API documentation for this service and summarize key limitations"
  - "Run the technical researcher to assess the code quality and architecture of this repository"
---
