...
examples:
  - "Use the URL link extractor to catalog all internal and external links in this codebase"
  - "Have the URL link extractor find all API endpoint references and asset URLs in this project"
  - "Run the URL link extractor to build a complete link inventory before we do the site migration"
---
