...
examples:
  - "Use the python expert to refactor this script to use async/await properly"
  - "Have the python expert optimize this generator pipeline for memory efficiency"
  - "Run the python expert to add decorators and type hints to this class"
---
