...
category: data-ai
examples:
  - "Use the ai-engineer to build a RAG pipeline over our documentation"
  - "Have the ai-engineer implement vector search using pgvector for this knowledge base"
  - "Run the ai-engineer to wire up an OpenAI-compatible API endpoint for our chatbot"
---
