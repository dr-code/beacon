...
examples:
  - "Use the ruby expert to refactor this Ruby class to follow SOLID principles"
  - "Have the ruby expert convert this procedural script into a service object pattern"
  - "Run the ruby expert to optimize this ActiveRecord query and add RSpec tests"
---
