...
examples:
  - "Use the debugger to figure out why this test is failing intermittently"
  - "Have the debugger trace this runtime error that only appears in production"
  - "Run the debugger on this build failure — I can't tell where it's breaking"
---
