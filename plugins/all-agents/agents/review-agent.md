...
examples:
  - "Use the review agent to validate the tagging and formatting consistency across my vault"
  - "Have the review agent cross-check the work done by the enhancement agents for quality issues"
  - "Run the review agent to audit this knowledge base for structural inconsistencies"
---
