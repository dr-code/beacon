...
category: data-ai
examples:
  - "Use the context-manager to coordinate state across these three agents working on the same codebase"
  - "Have the context-manager preserve progress from this session before we hit the context limit"
  - "Run the context-manager to manage this multi-agent refactor that will span several sessions"
---
