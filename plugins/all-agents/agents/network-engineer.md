...
examples:
  - "Use the network-engineer to debug why requests between these two services are timing out"
  - "Have the network-engineer configure the load balancer and SSL termination for this deployment"
  - "Use the network-engineer to diagnose the DNS resolution issues affecting our CDN"
---
