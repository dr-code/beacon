...
examples:
  - "Use the URL context validator to check whether these links are relevant to the surrounding content"
  - "Have the URL context validator verify that these documentation links point to appropriate sources"
  - "Run the URL context validator to audit this page for broken and contextually mismatched links"
---
