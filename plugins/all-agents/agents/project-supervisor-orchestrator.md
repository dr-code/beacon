...
examples:
  - "Use the project supervisor orchestrator to coordinate the data ingestion, processing, and reporting pipeline"
  - "Have the project supervisor orchestrator manage this multi-agent workflow end to end"
  - "Run the project supervisor orchestrator to detect which steps are incomplete and requeue them"
---
