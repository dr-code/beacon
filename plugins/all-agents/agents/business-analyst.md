...
examples:
  - "Use the business-analyst to build a revenue projection model for next quarter"
  - "Have the business-analyst create a KPI dashboard for our growth metrics"
  - "Run the business-analyst to analyze this cohort data and summarize trends for investors"
---
