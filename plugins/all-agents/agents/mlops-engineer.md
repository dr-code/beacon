...
category: data-ai
examples:
  - "Use the mlops-engineer to set up MLflow experiment tracking for this project"
  - "Have the mlops-engineer build a Kubeflow pipeline with automated retraining triggers"
  - "Use the mlops-engineer to implement data versioning and reproducibility for our model training runs"
---
