...
examples:
  - "Use the cloud-architect to design a multi-region AWS deployment with auto-scaling"
  - "Have the cloud-architect write Terraform modules for our VPC and EKS cluster"
  - "Run the cloud-architect to audit our cloud spend and recommend cost optimizations"
---
