...
examples:
  - "Use the drupal-developer to build a custom module for this content workflow"
  - "Have the drupal-developer create a Drupal theme that matches this design spec"
  - "Run the drupal-developer to optimize performance for this Drupal 10 site"
---
