...
examples:
  - "Use the content-marketer to write a blog post announcing this new feature"
  - "Have the content-marketer create a two-week social media content calendar for our product launch"
  - "Run the content-marketer to draft an SEO-optimized article about our API capabilities"
---
