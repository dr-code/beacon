...
category: data-ai
examples:
  - "Use the data-scientist to write a BigQuery query analyzing user churn over the last 90 days"
  - "Have the data-scientist build a SQL report breaking down revenue by region and product"
  - "Run the data-scientist to analyze this dataset and surface the top correlating features"
---
