...
examples:
  - "Use the research orchestrator to run a full deep research workflow on this topic"
  - "Have the research orchestrator break this complex question into phases and coordinate the agents"
  - "Run the research orchestrator to produce a thorough, citation-backed research output on this subject"
---
