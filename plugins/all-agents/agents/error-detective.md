...
examples:
  - "Use the error-detective to find the root cause of these 500 errors in production"
  - "Have the error-detective analyze these application logs for recurring error patterns"
  - "Run the error-detective to investigate why our service keeps crashing overnight"
---
