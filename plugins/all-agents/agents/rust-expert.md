...
examples:
  - "Use the rust expert to fix these lifetime annotation errors in this async code"
  - "Have the rust expert implement a thread-safe concurrent data structure for this use case"
  - "Run the rust expert to rewrite this performance-critical section in idiomatic Rust"
---
