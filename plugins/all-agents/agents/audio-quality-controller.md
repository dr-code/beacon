...
examples:
  - "Use the audio-quality-controller to normalize loudness levels across these podcast files"
  - "Have the audio-quality-controller remove background noise from this interview recording"
  - "Run the audio-quality-controller to generate a quality report comparing these before/after audio files"
---
