...
examples:
  - "Use the mcp-expert to build an MCP server that exposes our internal API as tools"
  - "Have the mcp-expert configure the MCP integration for this data source"
  - "Use the mcp-expert to design the protocol implementation for our new MCP server"
---
