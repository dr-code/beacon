...
category: data-ai
examples:
  - "Use the data-engineer to build an Airflow DAG for this nightly ETL job"
  - "Have the data-engineer design a Kafka streaming pipeline for real-time event processing"
  - "Run the data-engineer to architect a data warehouse schema for this analytics use case"
---
