...
examples:
  - "Use the frontend-developer to build a dashboard page with shadcn/ui components"
  - "Have the frontend-developer create a responsive Next.js landing page with Tailwind CSS"
  - "Use the frontend-developer to set up SSR for our Next.js app router pages"
---
