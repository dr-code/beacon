...
examples:
  - "Use the database-admin to set up replication for this Postgres instance"
  - "Have the database-admin configure proper user permissions and roles for production"
  - "Run the database-admin to create a backup and recovery procedure for this database"
---
