...
category: data-ai
examples:
  - "Use the prompt engineer to improve this system prompt for my customer support agent"
  - "Have the prompt engineer rewrite this few-shot prompt to reduce hallucinations"
  - "Run the prompt engineer to optimize the instructions I'm passing to my OpenAI assistant"
---
