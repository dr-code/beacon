...
examples:
  - "Use the legacy-modernizer to migrate this jQuery codebase to modern JavaScript"
  - "Have the legacy-modernizer create a plan to incrementally reduce the technical debt in this old Rails app"
  - "Use the legacy-modernizer to update our deprecated dependencies without breaking backward compatibility"
---
