...
examples:
  - "Use the crypto-trader to build a mean-reversion strategy and connect it to the Binance API"
  - "Have the crypto-trader implement a dollar-cost averaging bot with stop-loss logic"
  - "Run the crypto-trader to design a portfolio rebalancing system for a multi-asset crypto fund"
---
