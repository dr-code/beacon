...
examples:
  - "Use the agent-expert to design a new agent for code migration tasks"
  - "Have the agent-expert review this agent's prompt for weaknesses and improve it"
  - "Run the agent-expert to help me model a domain-specific agent for medical billing"
---
