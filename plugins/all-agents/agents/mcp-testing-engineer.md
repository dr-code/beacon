...
examples:
  - "Use the mcp-testing-engineer to validate this MCP server's JSON schema and protocol compliance"
  - "Have the mcp-testing-engineer write automated tests and run load testing on our MCP server"
  - "Use the mcp-testing-engineer to find security vulnerabilities in this MCP implementation"
---
