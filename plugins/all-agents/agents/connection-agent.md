...
examples:
  - "Use the connection-agent to find orphaned notes in my Obsidian vault that should be linked"
  - "Have the connection-agent suggest meaningful connections between these research notes on ML and biology"
  - "Run the connection-agent to map keyword overlaps across these project documentation files"
---
