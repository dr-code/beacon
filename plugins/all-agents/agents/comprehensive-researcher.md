...
examples:
  - "Use the comprehensive-researcher to investigate the trade-offs between gRPC and REST for high-throughput services"
  - "Have the comprehensive-researcher produce a structured report on no-code platform limitations"
  - "Run the comprehensive-researcher to cross-verify these conflicting claims about container orchestration performance"
---
