...
examples:
  - "Use the podcast-trend-scout to find emerging AI topics worth covering in our next tech episode"
  - "Have the podcast-trend-scout research current breaking developments aligned with our podcast's focus areas"
  - "Use the podcast-trend-scout to suggest timely episode topics based on what's trending in tech this week"
---
