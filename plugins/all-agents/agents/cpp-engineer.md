...
examples:
  - "Use the cpp-engineer to refactor this legacy C++ code to use RAII and smart pointers"
  - "Have the cpp-engineer optimize this template metaprogramming implementation"
  - "Run the cpp-engineer to fix the move semantics in this custom container class"
---
