...
examples:
  - "Use the text comparison validator to verify the OCR output matches the original markdown file"
  - "Have the text comparison validator detect formatting discrepancies between this image extract and the source"
  - "Run the text comparison validator to flag any inconsistencies between scanned pages and their markdown versions"
---
