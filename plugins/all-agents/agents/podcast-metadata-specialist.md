...
examples:
  - "Use the podcast-metadata-specialist to generate SEO-optimized show notes and chapter timestamps for this episode"
  - "Have the podcast-metadata-specialist write platform-specific descriptions for Spotify and Apple Podcasts"
  - "Use the podcast-metadata-specialist to create social media posts and a formatted description from this episode"
---
