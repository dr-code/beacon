...
examples:
  - "Use the hackathon-ai-strategist to evaluate whether this project idea is feasible in 24 hours"
  - "Have the hackathon-ai-strategist brainstorm AI concepts that would impress judges for a healthcare hackathon"
  - "Use the hackathon-ai-strategist to review our pitch from a judge's perspective"
---
