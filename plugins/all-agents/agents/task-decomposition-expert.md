...
category: data-ai
examples:
  - "Use the task decomposition expert to break this large feature into actionable subtasks"
  - "Have the task decomposition expert figure out which agents and tools to combine for this workflow"
  - "Run the task decomposition expert to map out the steps needed to build this integration"
---
