...
examples:
  - "Use the arbitrage-bot to build a price monitoring system across Binance and Coinbase"
  - "Have the arbitrage-bot implement a triangular arbitrage strategy for DEX trading pairs"
  - "Run the arbitrage-bot to design a cross-exchange arbitrage system with latency considerations"
---
