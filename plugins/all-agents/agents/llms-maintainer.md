...
examples:
  - "Use the llms-maintainer to generate an llms.txt file for this documentation site"
  - "Have the llms-maintainer update the llms.txt after we restructured the site navigation"
  - "Run the llms-maintainer to create an AI crawler roadmap after the latest build"
---
