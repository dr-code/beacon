...
examples:
  - "Use the api-security-audit to check these endpoints for authentication vulnerabilities"
  - "Have the api-security-audit review our JWT implementation for common weaknesses"
  - "Run the api-security-audit to validate that our API meets OWASP top 10 security requirements"
---
