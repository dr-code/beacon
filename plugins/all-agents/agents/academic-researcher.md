...
examples:
  - "Use the academic-researcher to find peer-reviewed papers on mRNA vaccine efficacy"
  - "Have the academic-researcher verify whether this claim about antibiotic resistance is supported by current evidence"
  - "Run the academic-researcher to find scholarly sources on reinforcement learning from human feedback"
---
