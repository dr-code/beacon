...
examples:
  - "Use the ocr-grammar-fixer to clean up this scanned document with recognition errors"
  - "Have the ocr-grammar-fixer fix the spacing issues and misread characters in this OCR output"
  - "Use the ocr-grammar-fixer to correct this OCR-processed marketing copy before we publish it"
---
