...
examples:
  - "Use the golang-expert to refactor this service to use goroutines and channels properly"
  - "Have the golang-expert fix the concurrency race conditions in this Go code"
  - "Use the golang-expert to optimize this Go API for better performance"
---
