...
examples:
  - "Use the terraform specialist to write a reusable module for this VPC and ECS setup"
  - "Have the terraform specialist manage state and set up workspaces for dev, staging, and prod"
  - "Run the terraform specialist to automate this multi-environment infrastructure deployment"
---
