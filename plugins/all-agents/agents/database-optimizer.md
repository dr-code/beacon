...
examples:
  - "Use the database-optimizer to fix the N+1 queries in this ORM-generated code"
  - "Have the database-optimizer design indexes for these slow-running analytical queries"
  - "Run the database-optimizer to plan the migration strategy for this schema change"
---
