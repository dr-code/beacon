...
examples:
  - "Use the visual analysis OCR agent to extract and structure the text from these scanned document images"
  - "Have the visual analysis OCR agent convert this screenshot into formatted markdown"
  - "Run the visual analysis OCR agent to pull the content from these PNG slides into editable text"
---
