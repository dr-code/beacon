...
examples:
  - "Use the crypto-analyst to perform on-chain analysis of this token's wallet distribution"
  - "Have the crypto-analyst generate a sentiment analysis report for ETH based on recent data"
  - "Run the crypto-analyst to identify trading signals for this altcoin pair"
---
