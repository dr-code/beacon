...
examples:
  - "Use the legal-advisor to draft a GDPR-compliant privacy policy for our SaaS app"
  - "Have the legal-advisor write terms of service and a cookie consent policy for our website"
  - "Use the legal-advisor to create a data processing agreement for our EU customers"
---
