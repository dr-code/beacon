...
examples:
  - "Use the devops-troubleshooter to diagnose why this pod keeps crashing in production"
  - "Have the devops-troubleshooter analyze these application logs and find the root cause of the outage"
  - "Run the devops-troubleshooter to investigate why this deployment is failing silently"
---
