...
examples:
  - "Use the report generator to turn these research findings into a structured final report"
  - "Have the report generator write up this synthesized data with proper citations"
  - "Run the report generator to produce a comprehensive summary from these analyst notes"
---
