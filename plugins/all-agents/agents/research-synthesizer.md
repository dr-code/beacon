...
examples:
  - "Use the research synthesizer to merge findings from these five sources into a unified analysis"
  - "Have the research synthesizer identify common patterns across these research outputs"
  - "Run the research synthesizer to reconcile conflicting findings from different specialists"
---
