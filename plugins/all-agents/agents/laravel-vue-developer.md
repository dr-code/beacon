...
examples:
  - "Use the laravel-vue-developer to build a REST API with Laravel and a Vue3 frontend"
  - "Have the laravel-vue-developer set up Pinia state management for our Vue3 app"
  - "Use the laravel-vue-developer to integrate the Laravel backend with the Vue3 composition API components"
---
