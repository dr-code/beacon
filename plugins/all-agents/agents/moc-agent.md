...
examples:
  - "Use the moc-agent to generate Maps of Content for the orphaned notes in my vault"
  - "Have the moc-agent create navigation hubs for my project and topic clusters"
  - "Run the moc-agent to identify and link all disconnected notes in my Obsidian vault"
---
