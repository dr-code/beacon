...
examples:
  - "Use the c-developer to fix this memory leak in the buffer handling code"
  - "Have the c-developer optimize this embedded firmware routine for an ARM Cortex-M4"
  - "Run the c-developer to rewrite this pointer arithmetic section more safely"
---
