...
examples:
  - "Use the blockchain-developer to write and audit this ERC-20 token contract"
  - "Have the blockchain-developer optimize gas usage in this Solidity smart contract"
  - "Run the blockchain-developer to integrate Web3.js with our frontend for wallet connection"
---
