...
examples:
  - "Use the graphql-architect to design the schema for our new API"
  - "Have the graphql-architect fix the N+1 query problems in our GraphQL resolvers"
  - "Use the graphql-architect to implement real-time subscriptions for this data feed"
---
