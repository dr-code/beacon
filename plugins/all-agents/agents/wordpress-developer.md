...
examples:
  - "Use the WordPress developer to build a custom plugin for this membership feature"
  - "Have the WordPress developer create a custom post type and block for this content workflow"
  - "Run the WordPress developer to optimize this theme for performance and fix these security issues"
---
