...
examples:
  - "Use the backend-architect to design the API boundaries for this new microservice"
  - "Have the backend-architect review this database schema for scalability issues"
  - "Run the backend-architect to plan the service decomposition for our monolith migration"
---
