...
examples:
  - "Use the typescript expert to add strict generic types to this utility library"
  - "Have the typescript expert design discriminated unions for this state machine"
  - "Run the typescript expert to migrate this JavaScript module to fully typed TypeScript"
---
