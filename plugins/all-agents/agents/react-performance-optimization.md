...
examples:
  - "Use the react performance optimization agent to find what's causing unnecessary re-renders in this component tree"
  - "Have the react performance optimization agent analyze our bundle size and suggest code splitting opportunities"
  - "Run the react performance optimization agent to improve our Core Web Vitals scores"
---
