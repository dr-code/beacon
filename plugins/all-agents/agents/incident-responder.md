...
examples:
  - "Use the incident-responder immediately — our checkout service is down in production"
  - "Have the incident-responder coordinate the fix for this database outage and document the post-mortem"
  - "Run the incident-responder to triage and resolve this memory leak causing service crashes"
---
