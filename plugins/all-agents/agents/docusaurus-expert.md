...
examples:
  - "Use the docusaurus-expert to fix this broken sidebar configuration in our v3 docs site"
  - "Have the docusaurus-expert set up a custom theme with our brand colors"
  - "Run the docusaurus-expert to resolve this build error in our Docusaurus documentation"
---
