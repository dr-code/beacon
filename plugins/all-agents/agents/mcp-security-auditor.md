...
examples:
  - "Use the mcp-security-auditor to review this MCP server implementation for vulnerabilities"
  - "Have the mcp-security-auditor design an OAuth 2.1 authentication system for our MCP server"
  - "Use the mcp-security-auditor to audit the RBAC implementation in this MCP integration"
---
