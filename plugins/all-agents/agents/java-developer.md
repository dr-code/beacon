...
examples:
  - "Use the java-developer to optimize the JVM performance of this Spring Boot service"
  - "Have the java-developer refactor this code to use Java streams and modern concurrency patterns"
  - "Use the java-developer to implement a reactive pipeline with Spring WebFlux"
---
