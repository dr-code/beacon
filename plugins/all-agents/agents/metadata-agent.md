...
examples:
  - "Use the metadata-agent to add consistent frontmatter to all my vault notes"
  - "Have the metadata-agent generate tags and standardize metadata across these markdown files"
  - "Run the metadata-agent to update creation and modification dates in my Obsidian vault"
---
