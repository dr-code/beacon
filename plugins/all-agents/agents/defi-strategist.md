...
examples:
  - "Use the defi-strategist to design a yield farming strategy across Aave and Compound"
  - "Have the defi-strategist implement a liquidity provision bot for a Uniswap v3 pool"
  - "Run the defi-strategist to model the risk/reward of this DeFi protocol interaction"
---
