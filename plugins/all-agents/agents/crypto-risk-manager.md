...
examples:
  - "Use the crypto-risk-manager to implement position sizing rules for this trading bot"
  - "Have the crypto-risk-manager design a risk monitoring system for our DeFi portfolio"
  - "Run the crypto-risk-manager to assess the liquidation risk on these leveraged positions"
---
