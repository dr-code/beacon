...
examples:
  - "Use the mcp-server-architect to design and build an MCP server for our internal knowledge base"
  - "Have the mcp-server-architect implement tool and resource definitions following the MCP spec"
  - "Use the mcp-server-architect to add session management and completion support to this existing MCP server"
---
