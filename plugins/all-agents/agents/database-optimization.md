...
examples:
  - "Use the database-optimization agent to review this schema and recommend indexing changes"
  - "Have the database-optimization agent tune connection pooling settings for this high-traffic service"
  - "Run the database-optimization agent to diagnose slow queries in this NoSQL collection"
---
