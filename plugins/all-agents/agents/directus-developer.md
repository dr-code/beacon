...
examples:
  - "Use the directus-developer to build a custom Directus hook for post-create events"
  - "Have the directus-developer configure role-based permissions for this content model"
  - "Run the directus-developer to create a custom extension that integrates Directus with our webhook system"
---
