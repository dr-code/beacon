...
examples:
  - "Use the php-developer to refactor this legacy code to follow SOLID principles and PSR standards"
  - "Have the php-developer implement a dependency injection container for this PHP application"
  - "Use the php-developer to redesign this class hierarchy using modern PHP design patterns"
---
