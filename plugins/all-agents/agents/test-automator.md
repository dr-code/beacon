...
examples:
  - "Use the test automator to write unit and integration tests for this Express API"
  - "Have the test automator set up a full CI pipeline with mocking and test data fixtures"
  - "Run the test automator to increase test coverage on this untested service layer"
---
