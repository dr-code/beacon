...
examples:
  - "Use the deployment-engineer to set up a GitHub Actions pipeline for this Node.js app"
  - "Have the deployment-engineer write a Kubernetes deployment manifest for this service"
  - "Run the deployment-engineer to dockerize this application and configure a production-ready container"
---
