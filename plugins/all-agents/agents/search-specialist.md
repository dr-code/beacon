...
examples:
  - "Use the search specialist to find and verify sources on this technical topic"
  - "Have the search specialist do a competitive analysis using advanced search techniques"
  - "Run the search specialist to fact-check these claims with multi-source verification"
---
