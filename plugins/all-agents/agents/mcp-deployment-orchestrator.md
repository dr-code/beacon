...
examples:
  - "Use the mcp-deployment-orchestrator to containerize and deploy this MCP server to Kubernetes"
  - "Have the mcp-deployment-orchestrator set up autoscaling and monitoring for our MCP service in production"
  - "Use the mcp-deployment-orchestrator to create Helm charts and configure the service mesh for this deployment"
---
