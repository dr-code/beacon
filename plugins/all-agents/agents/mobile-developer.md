...
examples:
  - "Use the mobile-developer to build the offline sync feature for this React Native app"
  - "Have the mobile-developer implement push notifications and deep linking for our Flutter app"
  - "Use the mobile-developer to optimize this cross-platform app for both App Store and Play Store submission"
---
