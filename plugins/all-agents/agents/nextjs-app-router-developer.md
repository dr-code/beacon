...
examples:
  - "Use the nextjs-app-router-developer to migrate our Pages Router app to the App Router"
  - "Have the nextjs-app-router-developer implement Server Components and streaming for this data-heavy page"
  - "Use the nextjs-app-router-developer to set up parallel routes and advanced caching strategies in Next.js 14"
---
