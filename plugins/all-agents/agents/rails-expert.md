...
examples:
  - "Use the rails expert to refactor these controller actions into service objects"
  - "Have the rails expert set up Sidekiq background jobs for this email pipeline"
  - "Run the rails expert to review this API design and suggest Rails best practices"
---
