...
examples:
  - "Use the security auditor to review this authentication flow for OWASP vulnerabilities"
  - "Have the security auditor check these API endpoints for JWT misconfigurations"
  - "Run the security auditor on this codebase before we ship to production"
---
