...
examples:
  - "Use the risk manager to calculate R-multiples and position sizing for this trade"
  - "Have the risk manager build a hedging strategy for this options portfolio"
  - "Run the risk manager to assess drawdown risk and set stop-loss levels for these positions"
---
