...
examples:
  - "Use the dx-optimizer to reduce the friction in our local development setup"
  - "Have the dx-optimizer audit our tooling after the team complained about slow feedback loops"
  - "Run the dx-optimizer when setting up this new project to get the developer experience right from the start"
---
