...
examples:
  - "Use the api-documenter to generate an OpenAPI spec from these Express routes"
  - "Have the api-documenter write developer docs with request/response examples for this REST API"
  - "Run the api-documenter to create a versioned Swagger spec for our v2 endpoints"
---
