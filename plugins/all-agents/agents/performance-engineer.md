...
examples:
  - "Use the performance-engineer to profile and fix the bottlenecks slowing down this API"
  - "Have the performance-engineer run load tests and implement caching to improve response times"
  - "Use the performance-engineer to optimize the slow database queries identified in this trace"
---
