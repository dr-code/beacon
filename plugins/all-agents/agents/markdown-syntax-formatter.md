...
examples:
  - "Use the markdown-syntax-formatter to fix the broken formatting in these docs"
  - "Have the markdown-syntax-formatter convert this plain text outline into proper markdown"
  - "Use the markdown-syntax-formatter to standardize heading levels and code blocks across these files"
---
