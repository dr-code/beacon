...
examples:
  - "Use the accessibility-specialist to audit this form for WCAG 2.1 AA compliance"
  - "Have the accessibility-specialist add proper ARIA attributes to this modal component"
  - "Run the accessibility-specialist to check if this navigation menu works with keyboard-only navigation"
---
