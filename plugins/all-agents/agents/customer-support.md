...
examples:
  - "Use the customer-support agent to draft canned responses for our top 10 support ticket categories"
  - "Have the customer-support agent write a troubleshooting guide for our onboarding flow"
  - "Run the customer-support agent to create an FAQ page based on these support tickets"
---
