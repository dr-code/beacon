...
examples:
  - "/setup-automated-releases on merge to main"
  - "/setup-automated-releases GitHub Actions workflow using semantic-release, auto-generate changelog, publish to npm on version tag push"
  - "/setup-automated-releases with Slack notification on successful release"
---
