...
allowed-tools: Edit
examples:
  - "/init-project my-api Node.js"
  - "/init-project patient-portal React TypeScript"
  - "/init-project clinic-scheduler MERN stack with JWT auth, role-based access, and Docker Compose setup"
---
