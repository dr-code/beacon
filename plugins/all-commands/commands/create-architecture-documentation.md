...
examples:
  ...
  - "/create-architecture-documentation generate C4 diagrams and decision log for the microservices backend"
  - "/create-architecture-documentation document data flow and service boundaries"
---
