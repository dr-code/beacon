...
examples:
  - "/decision-tree-explorer cloud provider selection"
  - "/decision-tree-explorer map deployment strategy options with probability-weighted outcomes for zero-downtime migration"
  - "/decision-tree-explorer pricing tier decision with churn and LTV projections"
---
