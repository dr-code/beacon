...
examples:
  ...
  - "/add-performance-monitoring integrate Datadog APM into the Express server with custom traces for database queries"
  - "/add-performance-monitoring set up web-vitals tracking in the React frontend and send metrics to a custom analytics endpoint"
---
