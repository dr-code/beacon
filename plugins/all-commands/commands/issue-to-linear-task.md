...
examples:
  - "/issue-to-linear-task #88"
  - "/issue-to-linear-task #102 assign to ENG team"
  - "/issue-to-linear-task #74 convert to Linear task under project BACKEND with priority High and sprint 12"
---
