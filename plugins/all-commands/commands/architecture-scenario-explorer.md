...
allowed-tools: Glob
examples:
  - "/architecture-scenario-explorer monolith vs microservices for a healthcare SaaS with 50k users"
  - "/architecture-scenario-explorer evaluate switching from REST to GraphQL for the patient data API"
  - "/architecture-scenario-explorer compare event-driven vs request-response architecture for the notification system considering scale, latency, and team size"
---
