...
examples:
  - "/sync"
  - "/sync feature/user-auth"
  - "/sync reconcile task status for all commits on the current branch, marking tasks as complete where the commit message references a Linear task ID"
---
