...
examples:
  ...
  - "/migration-assistant analyze current MongoDB schema"
  - "/migration-assistant plan migration from MongoDB to PostgreSQL including data mapping, rollback strategy, and zero-downtime cutover steps"
---
