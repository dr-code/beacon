...
examples:
  - "/bidirectional-sync"
  - "/bidirectional-sync configure GitHub repo my-org/backend with Linear team ENG"
  - "/bidirectional-sync set up so that closing a GitHub issue also closes the linked Linear ticket and vice versa"
---
