...
examples:
  - "/project-timeline-simulator Q3 launch with 4 engineers"
  - "/project-timeline-simulator model payment feature delivery with 2 senior devs, 1 junior, 3-week sprint cadence, and 20% unplanned work buffer"
  - "/project-timeline-simulator risk scenario: one engineer leaves mid-project"
---
