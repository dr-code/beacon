...
examples:
  ...
  - "/setup-rate-limiting express-rate-limit with 10 requests per 15 minutes on /api/auth routes, return 429 with Retry-After header, bypass for internal IPs"
  - "/setup-rate-limiting tiered limits for free vs paid API users"
---
