...
allowed-tools: Read
examples:
  - "/log to Linear ENG-88"
  - "/log today's session to Obsidian"
  - "/log completed auth refactor tasks to Linear project BACKEND and update the milestone progress notes in Obsidian"
---
