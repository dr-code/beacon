...
examples:
  ...
  - "/generate-api-documentation routes/api/v2"
  - "/generate-api-documentation generate full OpenAPI 3.0 spec for all Express routes in server/routes including request/response schemas"
---
