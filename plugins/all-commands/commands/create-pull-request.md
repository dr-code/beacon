...
examples:
  - "/create-pull-request"
  - "/create-pull-request open PR for fix/session-expiry branch with linked issue and reviewer assignments"
  - "/create-pull-request generate PR description from recent commits and diff"
---
