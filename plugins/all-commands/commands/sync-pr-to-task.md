...
examples:
  - "/sync-pr-to-task"
  - "/sync-pr-to-task PR #142"
  - "/sync-pr-to-task link pull request #142 to Linear task ENG-88, update task status to In Review and add PR URL to the Linear task description"
---
