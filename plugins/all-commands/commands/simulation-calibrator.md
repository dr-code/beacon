...
examples:
  - "/simulation-calibrator sprint velocity model"
  - "/simulation-calibrator validate the timeline simulator against the last 6 sprints of actual data, detect optimism bias, and adjust story point deflation factor"
  - "/simulation-calibrator run 100 Monte Carlo iterations for Q3 delivery estimate"
---
