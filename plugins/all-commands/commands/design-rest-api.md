...
examples:
  - "/design-rest-api user management"
  - "/design-rest-api design versioned REST API for inventory service with pagination, filtering, and bulk operations"
  - "/design-rest-api notifications API with webhook and polling support"
---
