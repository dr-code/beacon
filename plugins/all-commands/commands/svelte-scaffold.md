...
examples:
  - "/svelte-scaffold blog feature"
  - "/svelte-scaffold new SvelteKit project with TypeScript and TailwindCSS"
  - "/svelte-scaffold a full authentication module with login, register, and password reset routes using SvelteKit form actions and Zod validation"
---
