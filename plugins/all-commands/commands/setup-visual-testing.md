...
examples:
  - "/setup-visual-testing with Playwright"
  - "/setup-visual-testing Chromatic with Storybook for component-level snapshots and Percy for full-page regression on critical user flows"
  - "/setup-visual-testing baseline screenshots for the checkout and dashboard pages"
---
