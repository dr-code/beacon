...
examples:
  - "/pac-update-status ticket:AUTH-42 in-progress"
  - "/pac-update-status ticket:PAY-17 done — all acceptance criteria met, PR #88 merged, deployed to staging"
  - "/pac-update-status epic:onboarding blocked — waiting on design assets for step 3"
---
