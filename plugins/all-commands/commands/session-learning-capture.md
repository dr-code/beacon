...
examples:
  ...
  - "/session-learning-capture document the JWT refresh token design decisions and the tradeoffs we discussed today"
  - "/session-learning-capture save key findings from the database optimization session to docs/learnings/"
---
