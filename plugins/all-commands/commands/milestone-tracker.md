...
examples:
  - "/milestone-tracker"
  - "/milestone-tracker Q2 backend goals"
  - "/milestone-tracker show progress on all open milestones with percentage complete, blocked items, and estimated completion dates"
---
