...
examples:
  ...
  - "/optimize-bundle-size client/src"
  - "/optimize-bundle-size analyze production bundle, identify top 5 largest dependencies, and suggest tree-shaking and lazy loading strategies"
---
