...
examples:
  ...
  - "/sync-linear-to-issues team:ENG status:In Progress"
  - "/sync-linear-to-issues pull all Linear tasks in the current sprint for team INFRA and create corresponding GitHub issues with labels mapped from Linear priority levels"
---
