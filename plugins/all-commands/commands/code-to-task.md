...
examples:
  - "/code-to-task"
  - "/code-to-task analyze src/payments and create Linear tasks for identified technical debt"
  - "/code-to-task convert TODOs in the user service to tracked Linear issues"
---
