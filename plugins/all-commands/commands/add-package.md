...
examples:
  - "/add-package zod dev"
  - "/add-package stripe production"
  - "/add-package react-query production and configure a default QueryClient with stale time and retry settings in the app root"
---
