...
examples:
  - "/refactor-code src/auth/middleware.js"
  - "/refactor-code server/routes/payments.js — eliminate duplicated validation logic, extract to shared middleware, maintain existing test coverage"
  - "/refactor-code reduce complexity in the UserController class"
---
