...
examples:
  ...
  - "/optimize-database-performance orders collection"
  - "/optimize-database-performance analyze slow query log, add missing indexes on the users and sessions collections, and rewrite the aggregation pipeline for the analytics dashboard"
---
