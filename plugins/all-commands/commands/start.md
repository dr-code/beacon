...
examples:
  - "/start implement user authentication with JWT"
  - "/start build the payment processing feature — decompose into subtasks, identify dependencies, and generate an execution plan for a 3-engineer team"
  - "/start migrate legacy REST endpoints to GraphQL"
---
