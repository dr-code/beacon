...
examples:
  - "/svelte-storybook-story Button.svelte"
  - "/svelte-storybook-story create stories for DataTable with sorting and pagination props"
  - "/svelte-storybook-story generate comprehensive stories for the Modal component covering default, with-footer, error, and loading states using CSF v5 defineMeta pattern"
---
