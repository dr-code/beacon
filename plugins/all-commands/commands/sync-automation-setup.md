...
examples:
  ...
  - "/sync-automation-setup GitHub to Linear on issue label change"
  - "/sync-automation-setup configure a workflow that automatically creates Linear tasks when GitHub issues are labeled 'bug' and closes them when the linked PR merges"
---
