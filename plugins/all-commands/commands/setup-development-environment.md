...
examples:
  ...
  - "/setup-development-environment Node 20, MongoDB local replica set, Redis, and environment variable scaffolding with .env.example"
  - "/setup-development-environment with Docker Compose for all services"
---
