...
examples:
  - "/bulk-import-issues"
  - "/bulk-import-issues import all open GitHub issues labeled bug from my-org/api into the ENG Linear team"
  - "/bulk-import-issues import GitHub issues from my-org/frontend filtered by milestone v2.0 and map them to the FRONTEND Linear project with priority mapping"
---
