...
examples:
  ...
  - "/create-feature scaffold email notification system with template engine, queue, and retry logic"
  - "/create-feature add export to CSV feature for reports module"
---
