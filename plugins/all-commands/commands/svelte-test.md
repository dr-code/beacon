...
examples:
  - "/svelte-test Button.svelte"
  - "/svelte-test write component tests for the SearchBar with debounce behavior"
  - "/svelte-test create full test suite for src/routes/api/users/+server.ts covering GET, POST, and error responses using Vitest and supertest"
---
