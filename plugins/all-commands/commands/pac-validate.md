...
examples:
  - "/pac-validate"
  - "/pac-validate epic:payment-processing — check all tickets have acceptance criteria, story points, and valid status transitions"
  - "/pac-validate --strict all epics and tickets against v2 spec"
---
