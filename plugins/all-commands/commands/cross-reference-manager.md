...
examples:
  ...
  - "/cross-reference-manager repair broken links between architecture docs and implementation references"
  - "/cross-reference-manager validate all internal doc links before release"
---
