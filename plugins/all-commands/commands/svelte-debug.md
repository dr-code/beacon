...
examples:
  - "/svelte-debug hydration mismatch"
  - "/svelte-debug TypeError: Cannot read properties of undefined in +page.svelte line 42"
  - "/svelte-debug SvelteKit throws 500 error on load function when fetching from API route, stack trace shows error originates in hooks.server.ts handle function"
---
