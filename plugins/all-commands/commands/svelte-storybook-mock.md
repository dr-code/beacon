...
examples:
  - "/svelte-storybook-mock $page store"
  - "/svelte-storybook-mock SvelteKit navigation and page stores for UserDashboard.svelte"
  - "/svelte-storybook-mock set up mocks for $page, $navigating, and fetch in stories for the checkout flow components that depend on SvelteKit server data"
---
