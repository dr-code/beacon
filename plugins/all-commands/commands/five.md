...
examples:
  - "/five API returns 500 on checkout"
  - "/five users cannot log in after password reset"
  - "/five production database connection pool exhausts under load causing cascading timeouts across all services"
---
