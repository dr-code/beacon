...
examples:
  - "/architecture-review"
  - "/architecture-review focus on the data layer and API boundary between the Express server and MongoDB"
  - "/architecture-review evaluate the current monolith structure and recommend whether and how to extract a separate auth service"
---
