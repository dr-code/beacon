...
examples:
  ...
  - "/svelte-component DataTable TypeScript"
  - "/svelte-component create a UserProfileCard component with TypeScript, props for avatar URL and display name, and slot support for actions"
---
