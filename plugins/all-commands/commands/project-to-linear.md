...
examples:
  - "/project-to-linear"
  - "/project-to-linear map all epics and open tickets to Linear team:backend, preserving priority and status"
  - "/project-to-linear sync authentication epic to Linear workspace with labels and assignees"
---
