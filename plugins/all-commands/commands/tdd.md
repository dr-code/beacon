...
examples:
  - "/tdd add email validation to UserService"
  - "/tdd implement cart total calculation"
  - "/tdd run red-green-refactor cycle for the password reset feature, starting with a failing test for the token expiry logic on a new branch feat/password-reset"
---
