...
examples:
  - "/dependency-audit"
  - "/dependency-audit scan package.json for high and critical CVEs and suggest patched versions"
  - "/dependency-audit check for outdated dependencies with known vulnerabilities"
---
