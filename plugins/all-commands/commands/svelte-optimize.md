...
examples:
  - "/svelte-optimize bundle size"
  - "/svelte-optimize reduce initial load time for src/routes/dashboard"
  - "/svelte-optimize analyze and reduce bundle size by identifying heavy dependencies, implement lazy loading for routes, and optimize image loading in the marketing pages"
---
