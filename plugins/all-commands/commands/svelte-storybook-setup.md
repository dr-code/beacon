...
examples:
  ...
  - "/svelte-storybook-setup with TypeScript and TailwindCSS"
  - "/svelte-storybook-setup initialize Storybook 8 for this SvelteKit project with @storybook/sveltekit, configure addons for accessibility and viewport testing, and set up MSW for API mocking"
---
