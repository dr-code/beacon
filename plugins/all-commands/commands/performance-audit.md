...
examples:
  - "/performance-audit"
  - "/performance-audit focus on API response times and database query latency under load"
  - "/performance-audit frontend bundle size, Time to First Byte, and Largest Contentful Paint"
---
