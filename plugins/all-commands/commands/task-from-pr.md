...
examples:
  - "/task-from-pr #88"
  - "/task-from-pr PR #88 team:ENG"
  - "/task-from-pr create a Linear task from PR #88, extract the problem statement from the PR description, assign to the current sprint, and set priority based on the bug label"
---
