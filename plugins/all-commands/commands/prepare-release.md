...
examples:
  ...
  - "/prepare-release v3.0.0 — validate changelog completeness, run smoke tests, confirm all blocking issues closed"
  - "/prepare-release v1.4.2 hotfix for production auth regression"
---
