...
examples:
  - "/svelte-test-fix"
  - "/svelte-test-fix UserForm.test.ts failing on fireEvent"
  - "/svelte-test-fix three tests in checkout.test.ts fail after migrating to Svelte 5, errors reference legacy $: reactive syntax in test expectations"
---
