...
examples:
  - "/add-changelog"
  - "/add-changelog using Keep a Changelog format starting from v1.0.0 with entries derived from git log"
  - "/add-changelog generate initial CHANGELOG.md from all commits since the first tag"
---
