...
examples:
  - "/setup-kubernetes-deployment for the API service"
  - "/setup-kubernetes-deployment create Deployment, Service, and HorizontalPodAutoscaler manifests for the Node API with resource limits and liveness probes"
  - "/setup-kubernetes-deployment staging namespace with ConfigMap and Secret references"
---
