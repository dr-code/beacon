...
examples:
  ...
  - "/implement-caching-strategy Redis for session storage"
  - "/implement-caching-strategy design and implement a two-layer cache using Redis and in-memory LRU for the product catalog API with cache invalidation on update"
---
