...
examples:
  - "/directory-deep-dive src/services"
  - "/directory-deep-dive server/middleware explain the purpose and interaction of each file"
  - "/directory-deep-dive src/components/forms"
---
