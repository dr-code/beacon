...
examples:
  - "/ultra-think database schema design"
  - "/ultra-think should we use microservices or a monolith"
  - "/ultra-think analyze the trade-offs of migrating our session management from JWT to server-side sessions, considering security, scalability, and the current Express/Redis stack"
---
