...
examples:
  ...
  - "/implement-graphql-api user and post types with resolvers"
  - "/implement-graphql-api implement GraphQL schema for the order management domain with mutations, subscriptions, and DataLoader for N+1 prevention"
---
