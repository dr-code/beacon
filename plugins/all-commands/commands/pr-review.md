...
examples:
  - "/pr-review 142"
  - "/pr-review https://github.com/org/repo/pull/88 — focus on security implications of the new auth middleware"
  - "/pr-review 200 with emphasis on SQL injection risks and missing test coverage"
---
