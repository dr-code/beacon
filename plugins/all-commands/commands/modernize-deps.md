...
examples:
  - "/modernize-deps"
  - "/modernize-deps server/package.json"
  - "/modernize-deps audit all dependencies, flag packages with known CVEs, and propose safe upgrade paths with breaking change notes"
---
