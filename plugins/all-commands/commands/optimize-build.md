...
examples:
  - "/optimize-build"
  - "/optimize-build Webpack config"
  - "/optimize-build analyze current Vite build, identify slow transforms and large chunks, and propose code-splitting and caching improvements"
---
