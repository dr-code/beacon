...
examples:
  ...
  - "/svelte-test-coverage src/lib/components"
  - "/svelte-test-coverage analyze current coverage report, identify untested branches in the form validation logic, and suggest priority tests to reach 80% coverage"
---
