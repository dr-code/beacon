...
examples:
  - "/svelte-migrate to Svelte 5"
  - "/svelte-migrate convert reactive declarations to runes"
  - "/svelte-migrate update this project from Svelte 4 to Svelte 5 runes mode, handle breaking changes in reactivity and event directives"
---
