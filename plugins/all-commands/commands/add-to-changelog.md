...
examples:
  - "/add-to-changelog 1.4.0 Added Support for multi-factor authentication via TOTP"
  - "/add-to-changelog 1.3.2 Fixed Race condition in the session refresh logic"
  - "/add-to-changelog 2.0.0 Changed Removed deprecated v1 API endpoints and migrated all clients to v2"
---
