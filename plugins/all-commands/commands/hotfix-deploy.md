...
examples:
  - "/hotfix-deploy broken login on prod"
  - "/hotfix-deploy v2.4.1 JWT secret rotation"
  - "/hotfix-deploy critical XSS vulnerability in comment renderer affecting all authenticated users, assess blast radius before deploying"
---
