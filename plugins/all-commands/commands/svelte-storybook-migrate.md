...
examples:
  - "/svelte-storybook-migrate to v8"
  - "/svelte-storybook-migrate update stories to Svelte CSF v5 format"
  - "/svelte-storybook-migrate upgrade from Storybook 7 to 8, convert all story files to use @storybook/sveltekit framework and adopt the new CSF v5 defineMeta API"
---
