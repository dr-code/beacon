...
examples:
  ...
  - "/containerize-application create multi-stage Dockerfile for Node.js API with production optimizations"
  - "/containerize-application add docker-compose setup with Postgres and Redis"
---
