...
examples:
  ...
  - "/project-health-check include test coverage, open issues, dependency staleness, and CI pass rate"
  - "/project-health-check flag any critical or high severity open bugs"
---
