...
examples:
  - "/setup-formatting Prettier for TypeScript"
  - "/setup-formatting Prettier with 2-space indent, single quotes, trailing commas, integrated with ESLint and a pre-commit Husky hook"
  - "/setup-formatting for a mixed Python and TypeScript monorepo"
---
