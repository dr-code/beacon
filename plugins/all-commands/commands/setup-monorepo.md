...
examples:
  ...
  - "/setup-monorepo pnpm workspaces with Turborepo, shared ESLint and TypeScript configs, and scoped packages for client, server, and shared utilities"
  - "/setup-monorepo migrate existing client/ and server/ directories into monorepo structure"
---
