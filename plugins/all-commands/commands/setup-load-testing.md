...
examples:
  ...
  - "/setup-load-testing k6 scripts simulating 500 concurrent users on the checkout endpoint with p95 latency threshold of 200ms"
  - "/setup-load-testing baseline and stress test scenarios for the authentication API"
---
