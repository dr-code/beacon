...
examples:
  - "/market-response-modeler SaaS price increase 20%"
  - "/market-response-modeler new competitor entering the market"
  - "/market-response-modeler model response to launching a freemium tier targeting SMB segment with behavioral churn prediction and 6-month revenue impact"
---
