...
examples:
  - "/design-database-schema multi-tenant SaaS"
  - "/design-database-schema design normalized schema for appointment scheduling with recurrence rules and provider availability"
  - "/design-database-schema e-commerce orders with variants and inventory tracking"
---
