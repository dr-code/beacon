...
examples:
  - "/create-command deploy-preview"
  - "/create-command create a new lint-staged command following existing hook patterns"
  - "/create-command scaffold audit-log command with argument parsing"
---
