...
examples:
  ...
  - "/migrate-to-typescript src/utils"
  - "/migrate-to-typescript convert entire server/ directory to strict TypeScript, add types to all Express handlers, and update tsconfig"
---
