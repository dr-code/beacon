...
allowed-tools: Write
examples:
  - "/write-tests UserService.js"
  - "/write-tests integration tests for /api/orders"
  - "/write-tests generate unit and integration tests for the checkout module using Jest, covering happy path, validation errors, and payment failure scenarios with mocked Stripe calls"
---
