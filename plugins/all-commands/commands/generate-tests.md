...
examples:
  ...
  - "/generate-tests authController with Jest and supertest"
  - "/generate-tests generate unit and integration tests for the cart service following existing Vitest conventions with mocked Stripe calls"
---
