...
examples:
  - "/security-hardening"
  - "/security-hardening apply HTTP security headers, disable directory listing, enforce TLS 1.2+ in the Express config"
  - "/security-hardening review and tighten CORS policy and cookie flags"
---
