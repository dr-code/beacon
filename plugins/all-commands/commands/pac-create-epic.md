...
allowed-tools: Write
examples:
  - "/pac-create-epic user authentication"
  - "/pac-create-epic Payment Processing — cover Stripe integration, subscription management, and invoice generation with acceptance criteria and story points"
  - "/pac-create-epic onboarding flow with milestones for Q2 launch"
---
