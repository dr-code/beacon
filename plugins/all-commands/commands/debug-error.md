...
examples:
  ...
  - "/debug-error ECONNREFUSED on database connection during startup in Docker environment"
  - "/debug-error 500 on POST /api/orders with payload containing nested line items"
---
