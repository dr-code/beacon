...
examples:
  - "/rollback-deploy production v2.0.1"
  - "/rollback-deploy production — payment service is returning 500s after today's deploy, roll back to last stable tag v1.9.8"
  - "/rollback-deploy staging environment to previous image"
---
