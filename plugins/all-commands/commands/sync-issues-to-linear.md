...
examples:
  ...
  - "/sync-issues-to-linear label:bug milestone:v2.1"
  - "/sync-issues-to-linear sync all open GitHub issues tagged 'backend' to Linear team ENG, mapping priority labels to Linear urgency and preserving assignees"
---
