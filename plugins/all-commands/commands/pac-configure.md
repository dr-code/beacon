...
examples:
  - "/pac-configure"
  - "/pac-configure product-name=ClinicApp version=1.0"
  - "/pac-configure initialize Product as Code for the patient portal with roadmap, feature flags, and changelog structure linked to the GitHub repo"
---
