...
examples:
  - "/linear-task-to-issue ENG-55"
  - "/linear-task-to-issue ENG-203 as GitHub bug report"
  - "/linear-task-to-issue ENG-178 convert to GitHub issue with full context, acceptance criteria, and linked PR references"
---
