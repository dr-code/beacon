...
examples:
  ...
  - "/add-mutation-testing using Stryker for the TypeScript source in src/services with a minimum threshold of 80%"
  - "/add-mutation-testing configure mutmut for the Python backend and integrate results into CI"
---
