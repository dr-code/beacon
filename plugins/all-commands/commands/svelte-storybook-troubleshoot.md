...
allowed-tools: Glob
examples:
  - "/svelte-storybook-troubleshoot build error"
  - "/svelte-storybook-troubleshoot module not found for $lib alias in stories"
  - "/svelte-storybook-troubleshoot Storybook fails to build with vite error about cannot resolve @sveltejs/kit import inside story file, works fine in the app itself"
---
