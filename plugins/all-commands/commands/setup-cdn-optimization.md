...
examples:
  - "/setup-cdn-optimization CloudFront for static assets"
  - "/setup-cdn-optimization configure cache-control headers, asset fingerprinting, and gzip compression for the React build served from S3 via CloudFront"
  - "/setup-cdn-optimization for images and video files with long TTLs"
---
