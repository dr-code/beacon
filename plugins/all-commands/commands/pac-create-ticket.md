...
allowed-tools: Write
examples:
  - "/pac-create-ticket add forgot password endpoint"
  - "/pac-create-ticket implement JWT refresh token rotation under the authentication epic, including unit tests and API documentation"
  - "/pac-create-ticket epic:payment-processing — add webhook handler for Stripe payment_intent.succeeded events"
---
