...
examples:
  ...
  - "/add-authentication-system OAuth2 with Google and GitHub providers, refresh token rotation, and role-based access control"
  - "/add-authentication-system session-based auth with bcrypt password hashing for an Express/MongoDB app"
---
