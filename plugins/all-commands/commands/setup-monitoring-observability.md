...
examples:
  ...
  - "/setup-monitoring-observability Prometheus metrics, Grafana dashboards, and structured JSON logging via Winston for the Express API"
  - "/setup-monitoring-observability with error alerting to PagerDuty on 5xx rate above 1%"
---
