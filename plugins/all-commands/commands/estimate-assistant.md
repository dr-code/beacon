...
examples:
  - "/estimate-assistant"
  - "/estimate-assistant user authentication feature with OAuth2 and JWT"
  - "/estimate-assistant full MERN stack e-commerce checkout flow including cart, payment integration, and order confirmation"
---
