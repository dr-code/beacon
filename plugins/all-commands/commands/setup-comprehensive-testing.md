...
examples:
  ...
  - "/setup-comprehensive-testing unit tests with Jest, integration tests with Supertest, and E2E with Playwright across the MERN stack"
  - "/setup-comprehensive-testing with coverage thresholds at 80% and CI integration"
---
