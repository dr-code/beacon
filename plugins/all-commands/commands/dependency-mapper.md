...
examples:
  - "/dependency-mapper"
  - "/dependency-mapper generate visual dependency graph for the payments module and identify circular imports"
  - "/dependency-mapper analyze which packages have the most downstream dependents"
---
