...
examples:
  - "/mermaid db/schema.sql"
  - "/mermaid db/schema.sql docs/erd.md"
  - "/mermaid db/migrations/latest.sql docs/diagrams/erd.mmd generate entity relationship diagram with cardinality labels"
---
