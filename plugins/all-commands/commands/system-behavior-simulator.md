...
examples:
  - "/system-behavior-simulator 1000 concurrent users"
  - "/system-behavior-simulator API gateway under 5x normal load"
  - "/system-behavior-simulator model checkout service behavior at 10k requests/minute with database connection pool of 20, identify bottlenecks and suggest capacity adjustments"
---
