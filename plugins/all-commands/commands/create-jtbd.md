...
examples:
  - "/create-jtbd password reset flow"
  - "/create-jtbd multi-factor authentication when logging into sensitive accounts docs/jtbd-mfa.md"
  - "/create-jtbd bulk data export for enterprise users"
---
