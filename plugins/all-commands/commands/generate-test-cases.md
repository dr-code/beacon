...
examples:
  - "/generate-test-cases user registration flow"
  - "/generate-test-cases payment processing edge cases"
  - "/generate-test-cases generate full coverage test cases for the order fulfillment state machine including cancellation and partial shipment paths"
---
