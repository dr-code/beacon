...
examples:
  ...
  - "/sync-conflict-resolver prefer Linear as source of truth for status fields"
  - "/sync-conflict-resolver set up conflict detection so that when title differs between GitHub and Linear, Linear wins, but GitHub body takes precedence for description fields"
---
