...
examples:
  ...
  - "/memory-spring-cleaning archive stale project notes"
  - "/memory-spring-cleaning remove outdated decisions, consolidate duplicate entries, and rebuild the MEMORY.md index"
---
