...
examples:
  ...
  - "/create-prd real-time collaborative editing for documents with conflict resolution docs/prd-collab.md"
  - "/create-prd billing and subscription management feature"
---
