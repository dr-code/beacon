...
examples:
  - "/digital-twin-creator hospital bed occupancy"
  - "/digital-twin-creator create digital twin for server infrastructure with load simulation and failure mode calibration"
  - "/digital-twin-creator model patient intake flow with real-world wait time data"
---
