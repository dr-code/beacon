...
examples:
  - "/unity-project-setup"
  - "/unity-project-setup mobile 2D platformer"
  - "/unity-project-setup create a professional Unity project structure for a multiplayer mobile game with folders for Scripts, Prefabs, ScriptableObjects, and CI configuration for GitHub Actions"
---
