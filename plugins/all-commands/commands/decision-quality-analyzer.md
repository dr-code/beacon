...
examples:
  - "/decision-quality-analyzer build vs buy for auth system"
  - "/decision-quality-analyzer evaluate monolith vs microservices decision with team size, deployment frequency, and ops maturity constraints"
  - "/decision-quality-analyzer assess database migration timing and rollback risk"
---
