...
examples:
  - "/report sprint-21 summary"
  - "/report full execution metrics for the payment epic including velocity, blockers, and time per ticket"
  - "/report weekly progress across all active epics"
---
