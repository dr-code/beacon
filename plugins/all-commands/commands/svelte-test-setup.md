...
examples:
  - "/svelte-test-setup"
  - "/svelte-test-setup with Vitest and Playwright"
  - "/svelte-test-setup configure Vitest for unit and component tests, Playwright for E2E, integrate with the existing CI pipeline, and add coverage reporting via v8"
---
