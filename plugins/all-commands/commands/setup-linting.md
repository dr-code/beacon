...
examples:
  - "/setup-linting ESLint for TypeScript"
  - "/setup-linting ESLint with Airbnb config, TypeScript rules, import ordering, and unused variable enforcement across src/ and test/"
  - "/setup-linting add linting to existing React project without breaking current code"
---
