...
examples:
  ...
  - "/create-onboarding-guide generate step-by-step setup guide for new backend engineers including env config and local DB setup"
  - "/create-onboarding-guide create frontend dev onboarding with component library walkthrough"
---
