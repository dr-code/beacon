...
examples:
  - "/e2e-setup"
  - "/e2e-setup React with Playwright and GitHub Actions CI"
  - "/e2e-setup Next.js app using Cypress, assess current test coverage gaps, and configure parallel test runs"
---
