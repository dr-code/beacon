...
examples:
  - "/outlook-automation"
  - "List my unread Outlook emails from today and draft replies to the ones flagged as important"
  - "Move all emails from this sender into a dedicated Outlook folder and mark them as read"
---
