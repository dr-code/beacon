...
examples:
  - "/linear-automation"
  - "List all Linear issues in the current cycle and group them by team"
  - "Create a new Linear project for our mobile app rewrite and add the backlog issues to it"
---
