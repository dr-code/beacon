...
examples:
  ...
  - "List all open PagerDuty incidents and show who is currently on-call for each service"
  - "Update the escalation policy for our payments service and add a new on-call rotation schedule"
---
