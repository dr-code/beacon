...
examples:
  ...
  - "Run a Google Analytics report showing page views and sessions for the last 30 days"
  - "List all my Google Analytics properties and show me the top key events for each"
---
