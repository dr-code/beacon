...
examples:
  - "/invoice-organizer"
  - "Organize all the invoices and receipts in my downloads folder for tax preparation"
  - "Scan these messy receipt files, extract the vendor and amount, and rename them consistently"
---
