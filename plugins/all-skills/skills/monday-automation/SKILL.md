...
examples:
  - "/monday-automation"
  - "List all items on my Monday.com board that are overdue and show the assigned owners"
  - "Create a new group in my project board and add these 5 items with their due dates"
---
