...
examples:
  - "/macos-design"
  - "Design a native macOS menu bar utility with a sidebar layout and traffic light controls"
  - "Build a Mac-style preferences window with a toolbar and pane-based navigation that feels like Apple built it"
---
