...
examples:
  ...
  - "Create a new Freshdesk ticket for this customer issue and assign it to tier-2 support"
  - "List all open tickets in Freshdesk that are past their SLA deadline"
---
