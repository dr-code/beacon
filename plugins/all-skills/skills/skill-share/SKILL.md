...
examples:
  - "/skill-share"
  - "Create a new skill for parsing log files and share it with our Slack team channel"
  - "Build a database backup skill and automatically post it to our #claude-skills Slack channel"
---
