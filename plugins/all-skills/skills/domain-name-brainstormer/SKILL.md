...
examples:
  ...
  - "Brainstorm domain names for my AI scheduling app and check availability across .com, .io, and .ai"
  - "I need creative domain name ideas for a healthcare SaaS — generate options and check which are available"
---
