...
examples:
  ...
  - "What are the Apple HIG guidelines for bottom navigation bars and tab bar behavior on iOS?"
  - "Write a design spec for our onboarding flow that follows iOS Human Interface Guidelines for accessibility"
---
