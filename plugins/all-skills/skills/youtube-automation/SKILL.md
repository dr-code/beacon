...
examples:
  - "/youtube-automation"
  - "Upload this video file to YouTube with the provided title, description, and tags"
  - "Get the analytics for my last 10 YouTube videos including views, watch time, and subscriber gains"
---
