...
examples:
  - "/json-canvas"
  - "Create a JSON Canvas file mapping out the architecture of our app with nodes and connections"
  - "Add a new group node to my existing .canvas file and connect it to the database node"
---
