...
examples:
  ...
  - "List all Mailchimp audiences and show the subscriber count and recent campaign stats for each"
  - "Create a new Mailchimp campaign for our monthly newsletter and add this segment as the audience"
---
