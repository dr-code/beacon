...
examples:
  - "/whatsapp-automation"
  - "Send a WhatsApp Business message using the order confirmation template to this customer"
  - "Upload a product image to WhatsApp Business media library for use in messages"
---
