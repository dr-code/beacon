...
examples:
  - "/miro-automation"
  - "Create a new Miro board for our sprint retrospective and add sticky notes for each category"
  - "List all my Miro boards and share the product roadmap board with my design team"
---
