...
examples:
  - "/posthog-automation"
  - "List all PostHog feature flags and show which ones are currently enabled for production"
  - "Query PostHog for user profiles that triggered the checkout event in the last 7 days"
---
