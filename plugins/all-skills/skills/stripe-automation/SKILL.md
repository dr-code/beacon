...
examples:
  - "/stripe-automation"
  - "List all failed Stripe charges from the past 7 days with customer details"
  - "Create a new Stripe subscription for customer cus_ABC123 on the pro monthly plan"
---
