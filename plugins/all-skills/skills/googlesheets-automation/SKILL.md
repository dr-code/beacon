...
examples:
  ...
  - "Read the data from Sheet1 of my spreadsheet and filter rows where column B is greater than 100"
  - "Write these results to a new tab in my Google Sheet and apply bold formatting to the header row"
---
