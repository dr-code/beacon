...
examples:
  ...
  - "Rewrite this tweet to maximize reach and engagement based on Twitter's algorithm"
  - "Analyze my last 5 tweets and suggest edits to improve their algorithmic performance"
---
