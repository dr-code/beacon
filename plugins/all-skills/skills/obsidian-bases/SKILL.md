...
examples:
  - "/obsidian-bases"
  - "Create an Obsidian .base file that shows all my project notes in a table view filtered by status"
  - "Add a card view and a formula column to my existing Obsidian Bases file"
---
