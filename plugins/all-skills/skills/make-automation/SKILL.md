...
examples:
  - "/make-automation"
  - "Look up the available Make operations for connecting Google Sheets to Slack"
  - "List all supported timezones and language enums I can use when building a Make scenario"
---
