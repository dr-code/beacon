...
examples:
  - "/wrike-automation"
  - "Create a new Wrike task in the Development folder assigned to the backend team due next Friday"
  - "List all Wrike tasks assigned to me that are overdue across all projects"
---
