...
examples:
  - "/mcp-builder"
  - "Guide me through building an MCP server in Python using FastMCP to wrap the Stripe API"
  - "I need to create a Node.js MCP server that exposes our internal database as tools for an LLM"
---
