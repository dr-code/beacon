...
examples:
  - "/notion-automation"
  - "Search my Notion workspace for all pages tagged as meeting notes from this month"
  - "Create a new Notion database page for our product roadmap with these properties and blocks"
---
