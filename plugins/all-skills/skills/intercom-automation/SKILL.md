...
examples:
  - "/intercom-automation"
  - "List all open Intercom conversations tagged as urgent and show the contact details"
  - "Search Intercom for all companies with more than 50 users and export their segments"
---
