...
examples:
  - "/postmark-automation"
  - "Send a templated welcome email via Postmark to this list of new users"
  - "Show me the delivery stats and bounce rates for emails sent through Postmark this week"
---
