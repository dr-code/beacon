...
examples:
  ...
  - "Upload this report to OneDrive and share it with edit permissions for my team"
  - "Search my OneDrive for all PDFs in the contracts folder and list them with their last modified dates"
---
