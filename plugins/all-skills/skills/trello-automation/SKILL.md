...
examples:
  - "/trello-automation"
  - "Create a Trello card in the In Progress list for the login bug fix and assign it to me"
  - "Move all cards in the Done list on my Sprint board to the archive"
---
